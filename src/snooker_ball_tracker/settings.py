...
class Settings():
    ...
    def __settings_object_hook(self, dct):
    ...
    def load(self, settings_file: str) -> tuple:
    ...
    def save(self, settings_file: str, settings: dict=None) -> tuple:
        ...
        try:
            with open(settings_file, "w") as fp:
                json.dump(settings_to_save, fp, indent=4, sort_keys=True, cls=self.__SettingsJSONEncoder)
        except Exception as error:
            return False, error
        else:
            return True, None
